...
QuadTreeNode::QuadTreeNode(QuadTreeRect bound, int capacity, int depth) : bound(bound), capacity(capacity), depth(depth)
{
}
...
void QuadTreeNode::query(QuadTreeRect &range, std::vector<QuadTreeRect> &result)
{
    // 如果查询范围与本节点边界不相交
